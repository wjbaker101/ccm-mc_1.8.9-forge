...
public final class EditColourGuiScreen extends GuiScreen {
    ...
    public EditColourGuiScreen(final RGBAProperty colour, final CustomCrosshair crosshair) {
        super("Edit Colour");
        ...
        final IntegerSliderGuiComponent redSlider = new IntegerSliderGuiComponent(this, -1, -1, 260, "Red", 0, 255, red.get());
        redSlider.setBaseThumbColour(new RGBA(240, 20, 20, 255));
        redSlider.setHoverThumbColour(new RGBA(210, 40, 40, 255));
        redSlider.bind(red);
        redSlider.addEvent(IOnValueChangedEvent.class, new IOnValueChangedEvent() {
			@Override
			public void invoke() {
			    EditColourGuiScreen.this.colour.set(EditColourGuiScreen.this.colour.get().setRed(redSlider.getValue()));
			}
		});

        IntegerProperty green = new IntegerProperty("fake_green", this.colour.get().getGreen());
        final IntegerSliderGuiComponent greenSlider = new IntegerSliderGuiComponent(this, -1, -1, 260, "Green", 0, 255, green.get());
        ...
        greenSlider.addEvent(IOnValueChangedEvent.class, new IOnValueChangedEvent() {
			@Override
			public void invoke() {
			    EditColourGuiScreen.this.colour.set(EditColourGuiScreen.this.colour.get().setGreen(greenSlider.getValue()));
			}
		});

        IntegerProperty blue = new IntegerProperty("fake_blue", this.colour.get().getBlue());
        final IntegerSliderGuiComponent blueSlider = new IntegerSliderGuiComponent(this, -1, -1, 260, "Blue", 0, 255, blue.get());
        ...
        blueSlider.addEvent(IOnValueChangedEvent.class, new IOnValueChangedEvent() {
			@Override
			public void invoke() {
			    EditColourGuiScreen.this.colour.set(EditColourGuiScreen.this.colour.get().setBlue(blueSlider.getValue()));
			}
		});

        IntegerProperty opacity = new IntegerProperty("fake_opacity", this.colour.get().getOpacity());
        final IntegerSliderGuiComponent opacitySlider = new IntegerSliderGuiComponent(this, -1, -1, 260, "Opacity", 0, 255, opacity.get());
        ...
        opacitySlider.addEvent(IOnValueChangedEvent.class, new IOnValueChangedEvent() {
			@Override
			public void invoke() {
			    EditColourGuiScreen.this.colour.set(EditColourGuiScreen.this.colour.get().setOpacity(opacitySlider.getValue()));
			}
		});

        ButtonGuiComponent doneButton = new ButtonGuiComponent(this, -1, -1, 50, 35, "Done");
        doneButton.addEvent(IOnClickEvent.class, new IOnClickEvent() {
			@Override
			public void invoke() {
			    Minecraft.getMinecraft().displayGuiScreen(new EditCrosshairGuiScreen(crosshair));
			}
		});
